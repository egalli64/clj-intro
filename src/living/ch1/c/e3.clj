...
(println "The var is put in the current namespace:" living.ch1.c.e3/username)
...
(require '[living.ch1.c.e3])
;; accessing a symbol from another namespace
(println "Explicit use of namespace:" living.ch1.c.e3/username)

;; switch namespace with require - preferred way
#_{:clj-kondo/ignore [:namespace-name-mismatch]}
(ns third
  (:require [living.ch1.c.e3 :as main]))
