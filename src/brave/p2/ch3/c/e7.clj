...
(defn -main []
  ...
  ;; shorthand
  (let [double #(* 2 %)] (println "The double of 5 is ..." (double 5)))

  ;; passing an anonymous function to a Higher Order Function
  (let [names ["Tom" "Bob" "Joe"], messages (map #(str "Hi, " % "!") names)]
  ...
  ;; same
  (let [hello (fn [first second & more] (str "Hi, " first ", " second " and " more "!"))]
