...
(defn -main []
    ...
    (println "An empty vector:" [])
    (println "A vector with three items:" [1 2 3])

    ;; same, but using the vector constructor
    (println "An empty vector:" (vector))
    (println "A vector with three entries:" (vector 1 2 3))
    ...
    ;; adding more elements to a vector by _conj function_
