...
(ns exercism.bob-test
  (:require [clojure.test :refer [deftest is]]
            [exercism.bob :refer [response-for]]
            )
  )
...
(deftest responds-to-questions
  (is (= "Sure." (response-for "Does this cryogenic chamber make me look fat?"))))
...
(deftest responds-to-acronyms
  (is (= "Whatever." (response-for "It's OK if you don't want to go to the DMV."))))

(deftest responds-to-forceful-questions
  (is (= "Calm down, I know what I'm doing!" (response-for "WHAT THE HELL WERE YOU THINKING?"))))
...
(deftest responds-to-shouting-with-special-characters
  (is (= "Whoa, chill out!" (response-for "ZOMG THE %^*@#$(*^ ZOMBIES ARE COMING!!11!!1!"))))
...
(deftest responds-to-non-question-ending-with-whitespace
  (is (= "Whatever." (response-for "This is a statement ending with whitespace      "))))
